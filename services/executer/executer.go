...
func NewExecutorService(ctx context.Context, logger *zap.Logger, task models.Task, repo SchedulerRepo, slack notifications.Sender, client *httpclient.Client) *ExecutorService {
